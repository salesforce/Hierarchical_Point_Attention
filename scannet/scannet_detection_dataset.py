...
############# Visualizaion ########
## from: https://github.com/facebookresearch/votenet/blob/main/scannet/scannet_detection_dataset.py
    
def viz_obb(pc, label, mask, angle_classes, angle_residuals,
    size_classes, size_residuals, sem_label, name=''):
    ...
    for i in range(K):
        ...
        print(obb)        
        oriented_boxes.append((sem_label[i], obb))
    pc_util.write_oriented_bbox(oriented_boxes, 'gt_obbs{}.pkl'.format(name))
