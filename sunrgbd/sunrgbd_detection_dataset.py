...
class SunrgbdDetectionVotesDataset(Dataset):
    def __init__(self, split_set='train', num_points=20000,
        ...
        if use_v1:
            self.data_path = os.path.join(data_root, f'sunrgbd_pc_bbox_votes_50k_v1_{split_set}')
        else:
            self.data_path = os.path.join(data_root, f'sunrgbd_pc_bbox_votes_50k_v2_{split_set}')
